<template>
    <v-carousel class=""
      ...
      show-arrows="hover"
    >
      <v-carousel-item class="m-5"
        v-for="(film, i) in films"
        :key="i"
        
      >
      <v-img
              :src="film.backgraoundPhoto"
              class="align-center ma-0 pa-0 rounded-2"
            ...
            <v-card dir="rtl" variant="text" height="100%" width="40%"
              class="mx-auto align-center text-white g-0 ms-0"
              >
